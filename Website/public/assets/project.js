...
function init(){
  ...
  const shivamTexture = new THREE.TextureLoader().load('../assets/images/zayvebanner.png');
  ...
  // plane 2
  const virtualDeadlineTexture = new THREE.TextureLoader().load('../assets/images/virtDeadline.png');
  ...
  //plane 3
  const websiteTexture = new THREE.TextureLoader().load('../assets/images/website.png');
  ...
  //plane 4
  const classcollabTexture = new THREE.TextureLoader().load('../assets/images/classcollab.png');
  ...
  //plane 5
  const conferenceTexture = new THREE.TextureLoader().load('../assets/images/conference.png');
